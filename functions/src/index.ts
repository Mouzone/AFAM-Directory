...
export const generateInviteLink = https.onCall({ enforceAppCheck: true, }, async (data, _context) => {
...
export const createUserWithRole = https.onCall({ enforceAppCheck: true, }, async (data, _context) => {
