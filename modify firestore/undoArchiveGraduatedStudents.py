...
def archiveGraduatedStudents():
    ...
    try:
        origin_collection = f"directory/afam/archive/student/{datetime.now().year}"
        destination_collection = "directory/afam/student"
        ...
        query_ref = origin_collection_ref.where("Grade", "==", "10")
